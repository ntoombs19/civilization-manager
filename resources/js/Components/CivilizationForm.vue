...
const submitLabel = props.submitLabel || (props.isEdit ? 'Save Changes' : 'Create Civilization');
      ...
      <form @submit.prevent="submit" class="space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between">
            <InputLabel for="uniqueBuildings" value="Unique Buildings" />
            <button
              type="button"
          ...
          <div v-for="(building, index) in form.uniqueBuildings" :key="index" class="mt-2 flex gap-2 items-start">
            <div class="flex-1">
              <TextInput
          ...
          <InputError :message="form.errors.uniqueBuildings" class="mt-2" />
        </div>
        ...
        <div>
          ...
          <div v-for="(unit, index) in form.uniqueUnits" :key="index" class="mt-2 flex gap-2 items-start">
            <div class="flex-1">
              <TextInput
                :id="`unit-name-${index}`"
                v-model="unit.name"
          ...
          <InputError :message="form.errors.uniqueUnits" class="mt-2" />
        </div>
        ...
        <div>
          ...
          <div v-for="(city, index) in form.cityNames" :key="index" class="mt-2 flex gap-2 items-start">
            <div class="flex-1">
              <TextInput
                :id="`city-${index}`"
        ...
        <div>
          ...
          <div v-for="(spy, index) in form.spyNames" :key="index" class="mt-2 flex gap-2 items-start">
            <div class="flex-1">
              <TextInput
                :id="`spy-${index}`"
